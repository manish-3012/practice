...
public class AuthorEntityRepositoryIntegrationTests {
    ...
    public void testThatAuthorCanBeCreatedAndRecalled() {
        AuthorEntity authorEntity = TestDataUtil.createTestAuthorEntity();
    ...
    public void testThatMultipleAuthorsCanBeCreatedAndRecalled() {
        AuthorEntity authorEntityA = TestDataUtil.createTestAuthorEntity();
    ...
    public void testThatGetAuthorsWithAgeLessThan() {
        AuthorEntity testAuthorAEntity = TestDataUtil.createTestAuthorEntity();
    ...
    public void testThatGetAuthorsWithAgeGreaterThan() {
        ...
        Iterable<AuthorEntity> result = underTest.ageGreaterThan(50);
